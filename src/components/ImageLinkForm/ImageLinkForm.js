        ...
        <div>
            ...
            <div className='center'>
                <div className='form center pa4 br3 shadow-5'>
                    <input className='f4 pa2 w-70 br-0 bt-0 bw1 bl bl-0 b--black bg-transparent outline-0' type='text' placeholder='enter the link of an image here' onChange={onInputChange}/> {/* create event listener for the text input and on change call onInputChange from App.js and pass the event: onInputChange(event) */}
